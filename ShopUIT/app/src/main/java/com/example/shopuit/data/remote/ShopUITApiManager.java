...
public class ShopUITApiManager {
    ...
    public void getAllSanPhams(Callback<List<SanPham>> callback){
        Call<List<SanPham>> sanphams = service.getAllSanPhams();
        sanphams.enqueue(callback);
    }

    public void getSanPhamById (int id, Callback<List<SanPham>> callback){
        Call<List<SanPham>> sanphams = service.getSanPhamById(id);
        sanphams.enqueue(callback);
    }
}
